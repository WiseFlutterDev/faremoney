...
class fund_wallet extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      title: 'FUND WALLET',
      home: MyHomePage('FUND WALLET'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _handlePaymentInitialization() async {
    ...
    final Flutterwave flutterwave = Flutterwave(
        context: context,
        publicKey: 'FLWPUBK_TEST-b24b5fe080319f68523ada0ef7571711-X',
        ...
        customization: Customization(title: "faremoney checkout"),
        isTestMode: true);
